...
steps = [
	...
	InsertEbuilds(sabayon_for_gentoo, select=["app-admin/equo", "app-admin/matter", "sys-apps/entropy", "sys-apps/entropy-server", "sys-apps/entropy-client-services","app-admin/rigo", "sys-apps/rigo-daemon", "sys-apps/magneto-core", "x11-misc/magneto-gtk", "x11-misc/magneto-gtk3", "kde-misc/magneto-kde", "app-misc/magneto-loader", "app-admin/authconfig", "app-cdr/isomd5sum", "app-i18n/langtable", "dev-libs/libreport", "dev-python/pyblock", "dev-python/python-cryptsetup", "dev-python/python-meh", "dev-python/python-ntplib", "dev-util/pykickstart", "net-misc/fcoe-utils", "net-misc/lldpad", "sys-apps/libhbalinux", "sys-auth/realmd", "sys-libs/libuser"], replace=True),
	InsertEbuilds(sabayon_distro_src, select=["app-admin/anaconda"], replace=True),
